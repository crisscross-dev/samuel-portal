...
<head>
    ...
    <title>JHS Admission Application - SCC Portal</title>
    ...
    <style>
        ...
        .process-steps li i.fa-arrow-right {
            color: #ccc;
            font-size: 0.65rem;
        }
...
<body>
    <div class="container py-3">
        ...
        <div class="header py-3">
            ...
            <h2>Junior High School Admission Application</h2>
        </div>
