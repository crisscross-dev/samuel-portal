...
@section('title', 'SHS Admission Application - SCC Portal')
...
<div class="patient-section">
    ...
    <div class="d-flex align-items-start justify-content-between flex-wrap gap-2 mb-3">
        <div>
            <h2 class="section-title mb-1">
                <i class="fas fa-graduation-cap me-2"></i>SHS Admission Form
            </h2>
            <p class="section-subtitle mb-0">Fill out the form completely and submit. You will proceed to entrance exam scheduling and payment.</p>
        </div>
        <span class="step-badge"><i class="fas fa-school"></i> Grade 11 &ndash; 12</span>
    </div>
    ...
    <form method="POST" action="{{ route('admission.shs.store') }}" enctype="multipart/form-data" novalidate>
        @csrf
        ...
        <div class="section-heading"><i class="fas fa-book me-1"></i> Elective Course Applying For</div>

        <div class="row mb-3">
            <div class="col-md-6">
                <label for="program_applied_id" class="form-label">Elective Course <span class="text-danger">*</span></label>
                <select
                    ...
                    <option value="{{ $prog->id }}" {{ old('program_applied_id') == $prog->id ? 'selected' : '' }}>
                        {{ $prog->name }}
                    </option>
                    @endforeach
                </select>
        ...
        <input type="hidden" name="year_level" id="year_level" value="{{ old('year_level', 11) }}">
        ...
        <div class="mb-3">
            <label for="elementary_school" class="form-label">Junior High School Last Attended</label>
            <div class="input-group">
                <input type="text"
        ...
        <button type="submit" class="btn btn-primary w-100 fw-semibold py-2 fs-6">
            <i class="fas fa-paper-plane me-2"></i> Submit SHS Application
        </button>
    </form>
