...
<div class="card" style="max-width: 600px;">
    <div class="card-header">
        <h6 class="mb-0"><i class="bi bi-building me-1"></i> Edit Department: {{ $department->name }}</h6>
    </div>
    <div class="card-body">
        <form method="POST" action="{{ route('admin.departments.update', $department) }}">
            ...
            <div class="mb-3">
                ...
                <select name="head_faculty_id" class="form-select @error('head_faculty_id') is-invalid @enderror">
                ...
                @error('head_faculty_id')<div class="invalid-feedback">{{ $message }}</div>@enderror
