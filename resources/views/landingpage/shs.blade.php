...
<div class="shs-page">
    ...
    <!-- Page Title -->
    <h2 class="jhs-section-title" style="padding-top:2rem;">Senior High School <span style="color:#f1c40f;">(Grade 11 to 12)</span></h2>
    ...
    <div class="jhs-video-section mb-4">
        ...
        <div class="jhs-video-text">
            ...
            <a href="{{ route('admission.shs') }}" class="jhs-enrol-btn mt-3 d-inline-flex">
    ...
    <!-- <div class="jhs-hero mb-4">
        <div class="jhs-hero-text">
            ...
            <br>
            <a href="{{ route('admission.shs') }}" class="jhs-enrol-btn">
    ...
    <div class="shs-features mb-4" style="margin-top: 1.5rem">
        <h3><i class="fas fa-star me-2"></i>What SCCGTI STRANDS Offers for Senior High School</h3>
        <ul>
            <li><i class="fas fa-check-circle"></i> Science, Technology, Engineering, and Mathematics (STEM)</li>
            <li><i class="fas fa-check-circle"></i> Humanities and Social Sciences (HUMMS)</li>
            <li><i class="fas fa-check-circle"></i> Accountancy, Business, and Management (ABM)</li>
            <li><i class="fas fa-check-circle"></i> Information and Communication Technology (ICT)</li>
        </ul>
    </div>
    ...
    <div class="mb-4" style="background:#fff; border-radius:12px; padding:2.5rem 3rem; box-shadow:0 2px 12px rgba(30,58,95,0.07); margin-top:1.5rem;">
        <h2 style="font-size:clamp(1.3rem,3vw,1.8rem); font-weight:900; text-align:center; text-transform:uppercase; color:#1e3a5f; margin-bottom:1.5rem; line-height:1.2;">
            Senior High School Department<br>Objectives
        </h2>
        <ol style="padding-left:1.25rem; margin:0; display:flex; flex-direction:column; gap:0.85rem;">
            <li style="font-size:0.95rem; line-height:1.65; color:#1e3a5f; font-weight:700;">
                Give every student an opportunity to receive quality education based on an enhanced curriculum that is internationally recognized and comparable;
            </li>
            <li style="font-size:0.95rem; line-height:1.65; color:#1e3a5f; font-weight:700;">
                Produce 21st-century graduates equipped with information, media and technology skills, learning and innovation skills, effective communication skills, research and communal skills, and life and career skills;
            </li>
            <li style="font-size:0.95rem; line-height:1.65; color:#1e3a5f; font-weight:700;">
                Produce graduates who possess competencies and skills relevant to the job market and in the pursuit of tertiary education imbued with the core values of the institution for the service of God and men; and
            </li>
            <li style="font-size:0.95rem; line-height:1.65; color:#1e3a5f; font-weight:700;">
                Produce a pool of highly qualified and adequately trained teachers who are competent, compassionate, and committed to the service of education.
            </li>
        </ol>
    </div>
    ...
    <!-- CTA Bottom -->
    <div class="shs-features mb-4" style="text-align:center; padding:2.5rem;">
