...
<div class="row g-4">
    ...
    <div class="col-md-5">
        <div class="card mb-3">
            ...
            <div class="card-body">
                <table class="table table-borderless mb-0">
                    <tr><th class="text-muted" style="width:40%">Department</th><td>{{ $section->gradeLevel->department->name ?? 'N/A' }}</td></tr>
                    <tr><th class="text-muted">Grade Level</th><td>{{ $section->gradeLevel->name ?? 'N/A' }}</td></tr>
                    <tr><th class="text-muted">Academic Year</th><td>{{ $section->academicYear->name ?? 'N/A' }}</td></tr>
                    <tr><th class="text-muted">Adviser</th><td>{{ $section->adviser?->user?->name ?? 'TBA' }}</td></tr>
                    <tr><th class="text-muted">Students</th><td>
        ...
        {{-- Students List --}}
        <div class="card">
            <div class="card-header"><h6 class="mb-0"><i class="bi bi-people me-1"></i> Assigned Students</h6></div>
            <div class="card-body p-0">
                <div class="table-responsive">
                    <table class="table table-sm mb-0">
                        <thead class="table-light">
                            <tr><th>#</th><th>Student ID</th><th>Name</th></tr>
                        </thead>
                        <tbody>
    ...
    <div class="col-md-7">
        <div class="card">
            <div class="card-header"><h6 class="mb-0"><i class="bi bi-book me-1"></i> Section Subjects ({{ $section->sectionSubjects->count() }})</h6></div>
            <div class="card-body p-0">
                <div class="table-responsive">
                    <table class="table table-hover mb-0">
                        <thead class="table-light">
                            <tr><th>Code</th><th>Subject</th><th>Faculty</th><th>Schedule</th><th>Room</th><th>Units</th></tr>
                        </thead>
                        <tbody>
                            ...
                            @empty
                                <tr><td colspan="6" class="text-center text-muted py-3">No subjects assigned to this section.</td></tr>
                            @endforelse
                        </tbody>
