...
class DepartmentController extends Controller
{
    public function index(): View
    {
        ...
        return view('registrar.departments.index', compact('departments'));
    }

    public function create(): View
    {
        return view('registrar.departments.create');
    }
    ...
    {
        // Only show active faculty belonging to THIS department for head assignment
        $facultyList = Faculty::with('user')
            ->where('department_id', $department->id)
            ->where('is_active', true)
            ->get();

        return view('registrar.departments.edit', compact('department', 'facultyList'));
    }
